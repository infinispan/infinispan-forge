...
public abstract class AbstractInfinispanExample extends BaseFacet implements InfinispanExample {
	...
	// versions
	private static final String INFINISPAN_VERSION = "5.2.6.Final";
	...
	@Override
	public void create(String targetPackage, InfinispanConfiguration configuration) {
		try {
	...
	private void createJavaSource(URL[] urls, String targetPackage) throws IOException {
		...
		for (URL sourceURL : urls) {
			JavaClass javaClass = 
					JavaSourceFacetUtils.getJavaClass(sourceURL.openStream(), targetPackage, javaSourceFacet);
