...
public enum InfinispanConfiguration {
	...
	private InfinispanConfiguration(String configurationName) {
		...
		this.inputStream = getClass().getResourceAsStream("/configurations/" + configurationName);
	}
	...
	public static InfinispanConfiguration getByConfigurationName(String configurationName) {
